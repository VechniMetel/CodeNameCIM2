ClientEvents.lang("zh_cn", (event) => {
	...
	addFluidLanguage("molten_bitumen", "熔融沥青")
	...
	addMaterialLanguage("magnesium", "镁")
	...
	addSolutionLanguage("mgcl2", "氯化镁", "MgCl₂")
	addSolutionLanguage("mgso4", "硫酸镁", "MgSO₄")
	...
	addCommonTooltipLanguage("cmi:enchanted_mechanism", "§9手持右键方块可生成经验")
	addCommonTooltipLanguage("cmi:nature_mechanism", "§a手持右键方块可以替代骨粉的功能")
	addCommonTooltipLanguage("cmi:nuclear_mechanism", "§3手持右键可以清除身上残留的辐射")
	addCommonTooltipLanguage("cmi:wooden_mechanism", "§a手持右键方块可以替代树木肥料的功能")
	...
	addCommonTooltipLanguage("#minecraft:pickaxes", "副手潜行+右键可破坏矿物节点(无掉落物)")
	...
	addCommonTooltipLanguage("portality:controller", "制作模块时不会消耗自身")
