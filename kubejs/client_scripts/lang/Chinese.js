ClientEvents.lang("zh_cn", (event) => {
	...
	addBlockLang("grey_reinforced_concrete", "灰色钢筋混凝土")
	addBlockLang("grey_reinforced_concrete_stairs", "灰色钢筋混凝土楼梯")
	addBlockLang("grey_reinforced_concrete_slab", "灰色钢筋混凝土台阶")
	addBlockLang("grey_reinforced_concrete_wall", "灰色钢筋混凝土墙")
	...
	event.add("gui.cmi.cell.page_turning", "翻页")
	addCellLang("tier_1",
		"莫托斯\n调查报告\n半径: 1,553km\n轨道: 环绕伊甸 396.200km\n质量: 68.3x10^21kg\n大气层: 无\n莫托斯是伊甸的卫星. 与地球的月球相似, 它主宰着伊甸\n的潮汐变化, 是这颗行星生态平衡中不可或缺的存在. \n然而, 莫托斯的地下结构远比人类最初的推测复杂. 纵横\n交错的通道在数十公里之外重新汇合, 最终汇入一个巨\n大的主洞腔. 地质探测显示, 这些洞穴大多形成于早期岩\n浆冷却阶段, 后期又被地下气体反复侵蚀扩大. 洞壁留存\n着明显的高温熔蚀痕迹, 部分区域甚至仍维持微弱的地热\n活动. \n在主洞腔的穹顶上, 分布着大量能反射银蓝色光辉的天\n然结晶带. 矿物分析表明, 这些结晶富含钴与银元素, 是\n莫托斯地下极为独特的矿脉结构. \n有趣的是, 人类在早期探索宇宙时, 曾流传过'月亮是奶\n酪'做的一说, 甚至还因此拍过一部粗糙的科幻电影. 谁\n也没想到, 若干世纪后, 在莫托斯表层裂缝中, 人们竟真\n的发现了一种质地柔软、颜色淡黄的物质, 看上去颇有\n几分'奶酪'的模样. \n化验结果显示, 这种物质含有复杂的有机化合物与水\n合结构, 其形成机制尚不明朗. 科研人员半开玩笑地称,\n它也许正是判断莫托斯是否存在生命迹象的关键——或\n者, 至少能证明人类的想象力一向走在科学前面. ",
		"迪奥尼索斯\n调查报告\n半径: 739km\n轨道: 环绕伊甸 931.400km\n质量: 2.4x10^21kg\n大气层: 有\n自奥林匹斯星系被发现以来, 狄奥尼索斯作为伊甸的第二\n卫星就一直受到重点关注. 该卫星处于宜居带中, 且具\n有大气层, 自然环境不可不谓得天独厚. 然而与伊甸不同\n的是, 派向狄奥尼索斯的探测器大多没能传回数据, 着陆\n器也大多在降落过程中就奇怪的传回了电子设备烧毁的\n报告. \n起初人类认为是狄奥尼索斯大气层成分快速腐蚀或烧穿\n了探测器外壳, 但是这个猜想在数个超量堆叠了防腐蚀\n与隔热材料的探测器同样着陆失败后被推翻. \n这时, 一群工程师突然抱出了一批数个世纪前抢救欧洲\n某核泄露事件的设备操作资料, 提出了一个大胆的猜想：\n这个星球表面核辐射超标. \n一个超轻型卫星被发向了奥林匹斯星系, 它的载重非常\n少: 一个盖革计数器, 一个通讯装置, 一个电源. \n当看到卫星发回的盖革计数器数据后, 几乎所有人都陷入\n了沉默. "
	)
	addCellLang("tier_2",
		"阿瑞斯\n调查报告\n半径: 3,742km\n轨道: 环绕恒星 1.6AU\n质量: 687.2x10^21kg\n大气层: 有\n阿瑞斯在伊甸殖民计划的早期被定位为'资源性星体'它的\n大气稀薄, 地表寒冷. 然而与严酷的气候相比, 其地形却\n出奇地平缓, 广袤的平原几乎贯穿整个星球. \n在这些平原之中, 分布着数量不多但极具特征的寒冷区\n域. 在那里, 大型冰刺如森林般耸立, 地表常年被薄雪覆\n盖, 温度长期维持在冰点以下. 经过多次探测与交流后, \n研究者将这一系列区域命名为'阿瑞斯极冠'. \n阿瑞斯的岩石结构与火星极为相似, 富含氧化铁的岩石呈\n现鲜艳的红色, 对于奥林匹斯星系的开发是不可多得的丰\n富钢铁来源. 同时, 阿瑞斯星球表面丰富的水储量也为人\n类在此建立工业基地提供了极大的便利. \n阿瑞斯地表有着大量凸起的石头阴影, 据推测是风化的硬\n质岩石. 这来自阿瑞斯频繁的地质变化. 将硬质岩石推到\n地表, 再经过风化, 地表就会出现大量凸起的碎石块. ",
		"赫菲斯托斯\n调查报告\n半径: 5,513km\n轨道: 环绕恒星 2.3AU\n质量: 833.9x10^21kg\n大气层: 有\n赫菲斯托斯是奥林匹斯星系内侧的一颗岩石星球. 该星球\n拥有极其丰富的铁钕矿物成分. 因为未知原因, 星球中所\n有的磁性金属元素都以具有磁性的结晶形态存在, 以至于\n赫菲斯托斯的磁场极其紊乱, 并不适合电子设备着陆考察\n与远程电磁波通信. \n由于极其紊乱的强电磁环境, 这个星球的地层中金属分布\n极其诡异, 其中的部分矿物甚至形成了自然的高纯铁, 自\n然钕磁铁,乃至天然钢材. 这些天然金属材料似乎也催生了\n一些以电磁能驱动的生物, 甚至基础的文明. \n据Olympus_21033考察队记载, 这个星球的野生生物\n对于人类并不友善, 一旦与其相遇请一定做好战斗准备. \n赫菲斯托斯的磁性金属似乎有着一些更加奇怪的性能, 对\n于人类技术来说成本极高的带有自动追踪能力的箭矢与\n远程操控悬浮工具的设备, 似乎可以使用这里的磁铁材料\n轻易制造. "
	)
	addCellLang("tier_3",
