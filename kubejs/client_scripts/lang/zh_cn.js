ClientEvents.lang("zh_cn", (event) => {
	...
	addSolutionLanguage("ptcl2", "氯化铂", "PtCl₄")
	...
	addCommonTooltipLanguage("ue_addons:nuclear_mechanism", "§3手持右键可以清除身上残留的辐射")
	...
	addCommonTooltipLanguage("ue_addons:sculk_mechanism", "§b手持右键可以发射一道音波尖啸")
	...
	addCommonTooltipLanguage("ue_addons:charged_amethyst", "拿到耳边能听到它一直在发出嗡嗡嗡的声音")
