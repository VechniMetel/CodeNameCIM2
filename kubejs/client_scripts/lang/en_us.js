ClientEvents.lang("zh_cn", (event) => {
    ...
    addAloneLanguaue(`text.${global.namespace}.dev`, "§0Under construction, only for references")
    addAloneLanguaue(`text.${global.namespace}.player`, "§0Do not represent the final quality")
