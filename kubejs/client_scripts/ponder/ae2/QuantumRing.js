Ponder.registry((event) => {
    event.create("ae2:quantum_ring")
        ...
        .scene("ae2:quantum_ring", "Quantum Connection", "ue_addons:ae2/quantum_ring", (scene) => {
            scene.showBasePlate()
            scene.idle(20)
            let ENDER_DUST = scene.world.createItemEntity([3.5, 1.5, 5.5], [0, 0, 0], "ae2:ender_dust")
            let SINGULARITY1 = scene.world.createItemEntity([3.5, 1.5, 5.5], [0, 0, 0], "ae2:singularity")
            let ENDER_PEARL = scene.world.createItemEntity([5.5, 1.5, 3.5], [0, 0, 0], "minecraft:ender_pearl")
            let SINGULARITY2 = scene.world.createItemEntity([5.5, 1.5, 3.5], [0, 0, 0], "ae2:singularity")
            scene.idle(20)
            ...
            scene.world.createEntity("ae2:tiny_tnt_primed", [4.5, 1.5, 4.5], event => { })
            scene.idle(80)
            ...
            let QUANTUM1 = scene.world.createItemEntity([3.5, 1.5, 5.5], [0, 0, 0], "ae2:quantum_entangled_singularity")
            let QUANTUM2 = scene.world.createItemEntity([3.5, 1.5, 5.5], [0, 0, 0], "ae2:quantum_entangled_singularity")
            let QUANTUM3 = scene.world.createItemEntity([5.5, 1.5, 3.5], [0, 0, 0], "ae2:quantum_entangled_singularity")
            let QUANTUM4 = scene.world.createItemEntity([5.5, 1.5, 3.5], [0, 0, 0], "ae2:quantum_entangled_singularity")
            scene.idle(40)
