Ponder.registry((event) => {
	event.create("ae2:controller")
		...
		.scene("ae2:controller", "ME Controller", "ue_addons:ae2/controller", (scene) => {
			...
			scene.text(40, "AE devices can be placed besides the controller or connected with wires", [3.5, 1.5, 3.5])
			scene.idle(60)
			...
			// 致密线缆可以传输32个频道
			scene.text(40, "Thick wires could transmit 32 channels", [3.5, 1.5, 2.5])
			scene.idle(60)

			// 而普通线缆只能传输8个频道
			scene.text(40, "while thin wires transmit only 8 channels", [3.5, 3.5, 2.5])
			scene.idle(60)
