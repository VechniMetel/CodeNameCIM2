BlockEvents.rightClicked("ue_addons:the_accelerator_of_mechanism_power", (event) => {
	...
	if (event.getItem().is("vintageimprovements:redstone_module")) {
...
BlockEvents.rightClicked((event) => {
	...
	if (item.id !== "vintageimprovements:redstone_module" || block.id !== "ue_addons:the_accelerator_of_mechanism_power") {
		return
	}
