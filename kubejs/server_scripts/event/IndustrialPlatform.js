BlockEvents.rightClicked("cmi:industrial_platform", (event) => {
    ...
    if (item.is("minecraft:cobblestone")) {
        level.runCommandSilent(`/fill ${FINX} ${POSY - 1} ${FINZ} ${FINX + 15} ${POSY + 11} ${FINZ + 15} air destroy`)
        ...
        level.runCommandSilent(`/fill ${FINX} ${POSY - 1} ${FINZ} ${FINX + 31} ${POSY + 11} ${FINZ + 31} air destroy`)
