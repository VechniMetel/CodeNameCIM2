ServerEvents.recipes((event) => {
	...
	global.metalGroup.forEach((metal) => {
		if (!(Ingredient.of(`#forge:storage_blocks/${metal}`).itemIds.length === 0)) {
			kubejs.shapeless(`9x #forge:ingots/${metal}`, [
		...
		if (!(Ingredient.of(`#forge:nuggets/${metal}`).itemIds.length === 0)) {
			kubejs.shapeless(`9x #forge:nuggets/${metal}`, [
				`#forge:ingots/${metal}`
			])
		...
		if (!(Ingredient.of(`#forge:raw_materials/${metal}`).itemIds.length === 0)) {
			if (!(Ingredient.of(`#forge:storage_blocks/raw_${metal}`).itemIds.length === 0)) {
				kubejs.shapeless(`9x #forge:raw_materials/${metal}`, [
		...
		if (!(Ingredient.of(`#forge:dusts/${metal}`).itemIds.length === 0)) {
			minecraft.smelting(`#forge:ingots/${metal}`, [
				`#forge:dusts/${metal}`
			])
			minecraft.blasting(`#forge:ingots/${metal}`, [
				`#forge:dusts/${metal}`
			])
			thermal.pulverizer(`#forge:dusts/${metal}`, [
				`#forge:ingots/${metal}`
			]).energy(2000)

			thermal.smelter(`#forge:ingots/${metal}`, [
				`#forge:dusts/${metal}`
			]).energy(1600)
			...
			if (!(Ingredient.of(`#forge:ores/${metal}`).itemIds.length === 0)) {
				thermal.pulverizer(`2x #forge:dusts/${metal}`, [
					`#forge:ores/${metal}`
				])
		...
		if (!(Ingredient.of(`#forge:plates/${metal}`).itemIds.length === 0)) {
			create.pressing(`#forge:plates/${metal}`, [
				`#forge:ingots/${metal}`
			])
			thermal.press(`#forge:plates/${metal}`, [
				`#forge:ingots/${metal}`
			])
			thermal.smelter(`#forge:ingots/${metal}`, [
				`#forge:plates/${metal}`
		...
		if (!(Ingredient.of(`#forge:rods/${metal}`).itemIds.length === 0)) {
			createaddition.rolling(`2x #forge:rods/${metal}`, [
				`#forge:ingots/${metal}`
			])
		...
		if (!(Ingredient.of(`#forge:gears/${metal}`).itemIds.length === 0)) {
			...
			thermal.smelter(`4x #forge:ingots/${metal}`, [
				`#forge:gears/${metal}`
			])
		...
		if (!(Ingredient.of(`#forge:coins/${metal}`).itemIds.length === 0)) {
			...
			if (!(Ingredient.of(`#forge:nuggets/${metal}`).itemIds.length === 0)) {
				...
				thermal.smelter(`3x #forge:nuggets/${metal}`, [
					`#forge:coins/${metal}`
				]).energy(800)
			} else {
