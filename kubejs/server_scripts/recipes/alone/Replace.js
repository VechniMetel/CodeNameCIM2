ServerEvents.recipes((event) => {
	...
	event.replaceInput({type:"minecraft:crafting_shaped"}, "ae2:engineering_processor", "cmi:smart_mechanism")
	event.replaceInput({type:"minecraft:crafting_shapeless"}, "ae2:logic_processor", "cmi:smart_mechanism")
	event.replaceInput({type:"minecraft:crafting_shapeless"}, "ae2:calculation_processor", "cmi:smart_mechanism")
	event.replaceInput({type:"minecraft:crafting_shapeless"}, "ae2:engineering_processor", "cmi:smart_mechanism")
