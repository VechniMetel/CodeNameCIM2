ServerEvents.recipes((event) => {
	...
	const iim = "ue_addons:incomplete_iron_mechanism"
	const icm = "ue_addons:incomplete_copper_mechanism"
	const iam = "ue_addons:incomplete_andesite_mechanism"
	const igm = "ue_addons:incomplete_gold_mechanism"
	const ipm = "ue_addons:incomplete_photosensitive_mechanism"
	const itm = "ue_addons:incomplete_thermal_mechanism"
	const ifm = "ue_addons:incomplete_feinforced_mechanism"
	const irm = "ue_addons:incomplete_resonant_mechanism"
	const inm = "ue_addons:incomplete_nature_mechanism"
	const itrm = "ue_addons:incomplete_nature_mechanism"
	const ilem = "ue_addons:incomplete_light_engineering_mechanism"
	const ihem = "ue_addons:incomplete_heavy_engineering_mechanism"
	const iem = "ue_addons:incomplete_ender_mechanism"
	const icom = "ue_addons:incomplete_coil_mechanism"
	const ienm = "ue_addons:incomplete_enchanted_mechanism"
	const ismm = "ue_addons:incomplete_smart_mechanism"
	const ibmm = "ue_addons:incomplete_basic_mekanism_mechanism"
	const iamm = "ue_addons:incomplete_advanced_mekanism_mechanism"
	const iemm = "ue_addons:incomplete_elite_mekanism_mechanism"
	const iumm = "ue_addons:incomplete_ultimate_mekanism_mechanism"
	const istm = "ue_addons:incomplete_structure_mechanism"
