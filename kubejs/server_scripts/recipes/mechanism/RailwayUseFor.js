ServerEvents.recipes(event => {
    ...
    .transitionalItem(inc_railc)
    .loops(1)
    .id("railways:crafting/track_coupler");
    event.remove({ output: 'create:schedule' })   //机械冻梨给加了搅拌配方，遂使用remove保险（）
    create.sequenced_assembly(
        '8x create:schedule',
        inc_stus,
        [
    ...
    .transitionalItem(inc_stus)
    .loops(1)
    .id("create:crafting/kinetics/schedule");
    create.sequenced_assembly(
        '8x create:track_station',
        inc_railc,
        [
