ServerEvents.recipes((event) => {
	...
	.outputItems([Item.of("minecraft:copper_ore",5),
		Item.of("minecraft:copper_ore",5).withChance(0.5),
	...
	.outputItems([Item.of("minecraft:deepslate_copper_ore",10),
		Item.of("minecraft:deepslate_copper_ore",5).withChance(0.5),
	...
	.outputItems([Item.of("minecraft:iron_ore",5),
		Item.of("minecraft:copper_ore",5).withChance(0.5),
	...
	.outputItems([Item.of("minecraft:deepslate_iron_ore",10),
		Item.of("minecraft:deepslate_iron_ore",5).withChance(0.5),
	...
	.outputItems([Item.of("minecraft:deepslate_coal_ore",5),
		Item.of("minecraft:deepslate_coal_ore",5).withChance(0.5)])
