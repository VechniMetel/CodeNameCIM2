        ...
        elements: [
            {
                weight: 1,
                element: {
                    location: `${global.namespace}:radar/radar_1`,
                    element_type: "minecraft:single_pool_element",
                    processors: "minecraft:empty",
                    projection: "rigid"
                }
            },
            {
                weight: 1,
                element: {
                    location: `${global.namespace}:radar/radar_2`,
                    element_type: "minecraft:single_pool_element",
                    processors: "minecraft:empty",
                    projection: "rigid"
                }
            },
            {
                weight: 1,
                element: {
                    location: `${global.namespace}:radar/radar_3`,
                    element_type: "minecraft:single_pool_element",
                    processors: "minecraft:empty",
                    projection: "rigid"
                }
            },
            {
                weight: 1,
                element: {
                    location: `${global.namespace}:radar/radar_4`,
                    element_type: "minecraft:single_pool_element",
                    processors: "minecraft:empty",
                    projection: "rigid"
                }
            },
            {
                weight: 1,
                element: {
                    location: `${global.namespace}:radar/radar_e`,
                    element_type: "minecraft:single_pool_element",
                    processors: "minecraft:empty",
                    projection: "rigid"
                }
