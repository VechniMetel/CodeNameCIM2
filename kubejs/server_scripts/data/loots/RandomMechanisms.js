ServerEvents.genericLootTables((event) => {
	event.addGeneric("cmi:gameplay/random_mechanisms/basic", (loot) => {
		loot.addPool((pool) => {
			pool.addItem("4x minecraft:iron_ingot")
				.randomChance(0.125)
			pool.addItem("4x minecraft:copper_ingot")
				.randomChance(0.25)
			pool.addItem("4x minecraft:gold_ingot")
				.randomChance(0.125)
			pool.addItem("8x minecraft:stone")
				.randomChance(0.25)
			pool.addItem("8x tconstruct:seared_stone")
				.randomChance(0.25)
			pool.addItem("8x minecraft:andesite")
				.randomChance(0.25)
			pool.addItem("4x minecraft:clay")
				.randomChance(0.25)
			pool.addItem("8x minecraft:sand")
				.randomChance(0.25)
			pool.addItem("4x minecraft:flint")
				.randomChance(0.25)
			pool.addItem("8x minecraft:deepslate")
				.randomChance(0.25)
			pool.addItem("4x minecraft:oak_sapling")
				.randomChance(0.125)
			pool.addItem("4x minecraft:birch_sapling")
				.randomChance(0.125)
			pool.addItem("4x thermal:rubberwood_sapling")
				.randomChance(0.125)
			pool.addItem("4x tconstruct:earth_slime_sapling")
				.randomChance(0.125)
			pool.addItem("4x minecraft:oak_log")
				.randomChance(0.25)
	...
	event.addGeneric("cmi:gameplay/random_mechanisms/mechanical", (loot) => {
		loot.addPool((pool) => {
			pool.addItem("4x create_andesite_alloy")
				.randomChance(0.25)
			pool.addItem("4x create:zinc_ingot")
				.randomChance(0.125)
			pool.addItem("4x create:brass_ingot")
				.randomChance(0.125)
			pool.addItem("8x create:shaft")
				.randomChance(0.125)
			pool.addItem("4x create:cogwheel")
				.randomChance(0.125)
			pool.addItem("8x minecraft:redstone")
				.randomChance(0.125)
			pool.addItem("4x create:polished_rose_quartz")
				.randomChance(0.25)
			pool.addItem("4x minecraft:iron_ingot")
				.randomChance(0.25)
	...
	event.addGeneric("cmi:gameplay/random_mechanisms/engineering", (loot) => {
		loot.addPool((pool) => {
			pool.addItem("4x immersiveengineering:ingot_aluminum")
				.randomChance(0.25)
